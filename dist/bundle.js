    ...
    shipNames.forEach(function (shipName) {
      ...
      if (orient === "x") {
        ...
        if (playerName === "ai") {
          ...
          var _cellPosY = (_cellRect.top - _gamePageRect.top - 1.5) / window.innerWidth * 100;
      ...
      if (orient === "y") {
        ...
        if (playerName === "player") {
          ...
          var _cellPosY2 = (_cellRect2.bottom - _gamePageRect2.top - _cellRect2.width * length - 1.5) / window.innerWidth * 100;
          ship.style.left = "".concat(_cellPosX2, "vw");
          ship.style.top = "".concat(_cellPosY2, "vw");
          ship.style.border = "2rem solid blue";
          ship.style.backgroundColor = "rgba(0, 0, 0, 0.2)";
        }
        if (playerName === "ai") {
